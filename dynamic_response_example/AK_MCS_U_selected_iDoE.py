...
nMC = 100000        #set to at least 100000 for lower probability
...
while True:
    ...
    print("iter ",iter, ": pf value ",Pf_hat)
...
plt.plot(function_calls_values, np.log(pf_hat_values), 'b-')
plt.xlabel('function_calls')
plt.ylabel('log_pf_hat')
