...
kriging = GaussianProcessRegressor(kernel=kernel, n_restarts_optimizer=10, normalize_y=True)
...
optimized_kernel = kriging.kernel_
print("Optimized Kernel:", optimized_kernel)
print("Optimized Length Scales:", kriging.kernel_.k2.length_scale)
print("Constant Kernel Value (variance):", kriging.kernel_.k1.constant_value)